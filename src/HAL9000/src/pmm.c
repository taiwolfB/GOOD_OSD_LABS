    ...
    )
{
    ...
    //3. Yes, a physical allocation comes after a VaSpace allocation, with the specified size.
    // From what I've seen, all the reservations were held in memory, even the big chunks.
    LOGL("Reserved physical frames from 0x%X of size 0x%X on behalf of [%s] process\n",
